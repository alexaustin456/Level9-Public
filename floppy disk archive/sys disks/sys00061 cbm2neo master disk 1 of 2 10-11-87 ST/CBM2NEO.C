...
copyright()
{ newline() ;
  prs("CBM 64 picture to ST/NEO format. 26-11-87") ;
  newline() ;
  newline() ;
...
{ int index ;
  ...
  writetwobytes ( fp , 0x0005 ) ; /* Colour 6 Blue   */
  ...
  writetwobytes ( fp , 0x0333 ) ; /* Colour 12 Med. Grey */
  writetwobytes ( fp , 0x0575 ) ; /* Colour 13 Lt. Green */
